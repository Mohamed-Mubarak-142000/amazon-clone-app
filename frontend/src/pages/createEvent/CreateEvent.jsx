...
const CreateEventContent = () => {
  ...
  const handleSubmit = (e) => {
    ...
    dispatch(createEvent({ formData, config, navigate }));
  };
  ...
  return (
    <div className="bg-white w-[100%]  800px:w-[60%] m-auto min-h-[80vh] rounded-sm shadow-md p-3 my-5 ">
      ...
      <form onSubmit={handleSubmit} className="my-[1rem]">
        ...
        <br />
        <div className="w-full leading-7">
          <label htmlFor="date" className="font-[600] capitalize">
        ...
        <div className="w-full leading-7">
          <label htmlFor="date" className="font-[600] capitalize">
            event finish date <span className="text-[red]">*</span>
          </label>
          <input
            type="date"
            name="date"
